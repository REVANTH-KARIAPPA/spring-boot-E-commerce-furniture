...
public class PaymentController {
    ...
    @PutMapping("/{pid}")
    public Payment addPayment(@Valid @RequestBody Payment payment, @PathVariable int pid) throws MessagingException{
        senderService.sendSimpleEmail(payment.getEmail(), "your payment at WOODO details are below \n"+payment.toString());
        return this.paymentService.addPayment(payment,pid);
